...
class NodeTreeView(AbstractNodeView[N], QTreeView):
    @override  # QTreeView
    def collapse(self, index_or_node: ModelIndex | N) -> None:
    ...
    @override  # QTreeView
    def expand(self, index_or_node: ModelIndex | N) -> None:
        return super().expand(self._to_index(index_or_node))

    @override  # QTreeView
    def expandRecursively(self, index_or_node: ModelIndex | N, depth: int = -1) -> None:
